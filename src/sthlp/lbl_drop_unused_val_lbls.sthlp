...
{hline}
{pstd}help file for {hi:lbl_drop_unused_val_lbls}{p_end}
{hline}

{title:Title}

{phang}{bf:lbl_drop_unused_val_lbls} - Drop value labels not attached to any variable.
{p_end}

{title:Syntax}

{phang}{bf:lbl_drop_unused_val_lbls} , [{bf:{ul:c}onfirm}]
{p_end}
...
{pstd}To eliminate any unattached value labels, drop them with {inp:lbl_drop_unused_val_lbls}. To check for and inspect unattached value labels, use {inp:lbl_list_unused_val_lbls}. 
{p_end}
...
{space 8}lbl_drop_unused_val_lbls, confirm
{space 8}n
{space 8}* if intrepid, drop without asking
{space 8}lbl_drop_unused_val_lbls
{text}
