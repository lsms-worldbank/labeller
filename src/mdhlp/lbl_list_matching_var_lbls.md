...
__lbl_list_matching_var_lbls__ _regexstring_, [__**neg**ate__ __**v**arlist__(_varlist_)]
...
lbl_list_matching_var_lbls "^[0-9]"
```
...
lbl_list_matching_var_lbls "^F", varlist(var1 - var3)
```
...
lbl_list_matching_var_lbls "^[0-9]", negate
```
